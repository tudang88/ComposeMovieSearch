 ...
 */
class FakeAndroidTestRepository(favoriteMoviesList: MutableList<MovieEntry> = mutableListOf()) :
    MovieResourceInterface {
    /**
     * fake remote data for local test the method which need to get from retrofit
     */
    private var moviesDataForSearch: LinkedHashMap<String, MovieEntry> = LinkedHashMap()
    private var movieDetailsData: LinkedHashMap<Int, MovieDetailsResponse> = LinkedHashMap()
